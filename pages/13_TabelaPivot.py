...
df_gols = pd.read_parquet(r"DataSet Project/football-transfermarkt-dataset-01/appearances.parquet")
df_vitorias = pd.read_parquet(r"DataSet Project/football-transfermarkt-dataset-01/club_games.parquet")
